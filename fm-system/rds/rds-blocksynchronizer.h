...
#ifndef __RDS_BLOCK_SYNCHRONIZER__
#define	__RDS_BLOCK_SYNCHRONIZER__
...
Q_OBJECT
public:
		rdsBlockSynchronizer	(duoReceiver *);
...
private:
	...
	uint32_t	correctErrors		(uint32_t);

...
//	Our wrapper is a simple classs
	rtlsdrHandler::rtlsdrHandler (QSettings *s, QWidget *widget):
...
//	OK, now open the hardware
	...
	setupUi (widget);
	widget	->  show ();
	QString deviceModel     = rtlsdr_get_device_name (deviceIndex);
...
//	See what the saved values are and restore the GUI settings
        rtlsdrSettings  -> beginGroup ("rtlsdr");
        QString temp =
...
void	rtlsdrHandler::setVFOFrequency	(int32_t freq) {
